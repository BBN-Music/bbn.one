...
export const getFirstByGenresByMusic = <ThrowOnError extends boolean = false>(options: Options<GetFirstByGenresByMusicData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetFirstByGenresByMusicResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseValidator: async (data) => {
            return await zGetFirstByGenresByMusicResponse.parseAsync(data);
        },
