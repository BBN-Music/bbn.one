...
import { appendBody, Content, FullWidthSection, Grid, Label, WebGenTheme } from "webgen/mod.ts";
...
appendBody(
    WebGenTheme(
        Content(
            ...
            Grid(
                Label("Terms and Conditions").setTextSize("2xl").setFontWeight("bold"),
                Label("Definitions").setTextSize("xl").setFontWeight("bold"),
                ...
                Label("General Conditions; Access to and use of the Services").setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label("What You can do and what you can't do").setTextSize("xl").setFontWeight("bold"),
                Label("Use of the Platform").setFontWeight("bold"),
                Label(
                ...
                Label("Upload and storage of Your Content").setFontWeight("bold"),
                ...
                Label("Fees").setTextSize("xl").setFontWeight("bold"),
                ...
                Label("Duration and Termination").setTextSize("xl").setFontWeight("bold"),
                ...
                Label("Intellectual Property Rights").setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label("Fraud").setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label("Privacy").setTextSize("xl").setFontWeight("bold"),
                Label('8.1 Our data protection policy is described in the Privacy Policy. The Privacy Policy is part of our relationship and, therefore, when you accept these Terms of Use, you are also acknowledging and accepting our Privacy Policy, which is available in the "Company" section on our website.'),
                Label("Warranty. Limitation of Liability").setTextSize("xl").setFontWeight("bold"),
                Label(
                ...
                Label("Miscellaneous").setTextSize("xl").setFontWeight("bold"),
            ...
            ).setGap().setMargin("5rem auto 0").setCssStyle("whiteSpace", "pre-wrap"),
        ),
        Footer(),
    ),
);
